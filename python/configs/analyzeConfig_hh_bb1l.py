    ...
    for lepton_selection in self.lepton_selections:
      ...
      for lepton_frWeight in self.lepton_frWeights:
              ...
              for genMatch_category in genMatch_categories:
                for category in self.evtCategories:
                  ...
                  if genMatch_category == "nonfake":
                    ...
                    addBackgrounds_job_tuple = (category, process_name, sample_category, lepton_selection_and_frWeight)
                  if genMatch_category == "conversions":
                    ...
                    addBackgrounds_job_tuple = (category, process_name, "%s_conversion" % sample_category, lepton_selection_and_frWeight)
                    ...
                    addBackgrounds_job_tuple = (category, process_name, "%s_fake" % sample_category, lepton_selection_and_frWeight)
                  if processes_input:
        ...
        for category in self.evtCategories:
          ...
          addBackgrounds_job_conversions_tuple = ("conversions", category, lepton_selection)
